...
class AcademyRenderer extends React.Component{
  ...
  componentDidMount(): void {
    ...
    this.renderer = new WebGLRenderer({ canvas: this.myCanvas, antialias:true});
    ...
    this.geometry = new SphereGeometry(6, 30, 30);
...
export default AcademyRenderer;